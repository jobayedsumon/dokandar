        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="{{ route('generalsettings.update',$generalsetting->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="google_plus">{{__('Notice')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="notices" name="notice" value="{{ $generalsetting->notice }}" class="form-control">
                        </div>
                    </div>
                </div>
