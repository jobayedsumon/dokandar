		...
		<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					@endif
					<div class="form-group">
							<label class="col-lg-2 control-label">{{__('Top Brand')}}</label>
							<div class="col-lg-7">
								<label class="switch" style="margin-top:5px;">
									<input type="checkbox" name="topbrand" checked>
									<span class="slider round"></span></label>
								</label>
							</div>
						</div>
					...
					<div class="form-group">
							<label class="col-lg-2 control-label">{{__('Weekly Best Selling')}}</label>
							<div class="col-lg-7">
								<label class="switch" style="margin-top:5px;">
									<input type="checkbox" name="weeklysell" checked>
		                            <span class="slider round"></span></label>
								</label>
							</div>
					</div>
