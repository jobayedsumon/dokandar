                    ...
                    <div class="col">
                        <a href="{{ route('home') }}" class="d-block">
                            @if($generalsetting->logo != null)
                                <img src="{{ asset($generalsetting->logo) }}" class="" height="32">
                            @else
                                <img src="{{ asset('frontend/images/logo/logo.png') }}" class="" height="32">
                            @endif
                        </a>
                ...
                <div class="col-md-2">
                    <div class="col text-center text-md-left">
                       ...
                       <ul class="footer-links">
                                ...
                                <li>
                                    <a href="{{ route('sellerpolicy') }}" title="Sellerpolicy">
                                        {{__('Seller policy')}}
                                    </a>
                                </li>
                            
                                <li>
                                    <a href="{{ route('returnpolicy') }}" title="Return policy">
                                    {{__('Return policy')}}
                                    </a>
                                </li>
                            
                            <li>
                                <a href="{{ route('supportpolicy') }}" title="Support policy">
                                {{__('About Us')}}
                                </a>
                            </li>
                            <li>
