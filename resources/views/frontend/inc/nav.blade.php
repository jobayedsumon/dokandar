<div class="header bg-white">
    ...
    <div class="notice_bar">
       <span class="notice_bar_title"> <marquee><a class="text-white" href="">{{ $generalsetting->notice }}</a></marquee></span>
    </div>
    <!-- Top Bar -->
            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        ...
                        @auth
                        <li>
                            <a href="{{ route('dashboard') }}" class="top-bar-item">{{__('Dashboard')}}</a>
                        </li>
                        <li>
